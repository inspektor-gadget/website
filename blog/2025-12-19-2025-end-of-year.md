...
A big friction point we kept hearing was this idea that "I know IG can capture exactly what I need, but I don't always remember which gadgets to use or the flags or the filter syntax that come along with kubectl gadget." The new [Inspektor Gadget MCP server](https://github.com/inspektor-gadget/inspektor-gadget/tree/main/cmd/ig-mcp-server) bridges that gap by letting users simply bring their problem to LLM-powered assistants using plain language. Behind the scenes, [MCP](https://modelcontextprotocol.io/) translates that into the right gadget invocations, parameters, and filters and then streams results back with context, making troubleshooting easier than ever.
