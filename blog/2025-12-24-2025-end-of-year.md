...
- [`ttysnoop`](https://inspektor-gadget.io/docs/latest/gadgets/ttysnoop/): Monitors interactive activity in containers. Helpful for auditing interactive sessions and investigating unexpected command execution to keep workloads secure.
...
With eBPF becoming pervasive, we heard a recurring need: “How do I know what eBPF is doing on my system? What is the impact here?” The [`bpfstats`](https://inspektor-gadget.io/docs/latest/gadgets/bpfstats) gadget and our [IG benchmark framework](https://github.com/inspektor-gadget/inspektor-gadget/pull/4730#top) answers that by giving operators real-time insight and metrics about loaded BPF programs and the overhead of IG on the system. This increases transparency and helps teams manage eBPF usage responsibly.
...
- Events: [KubeCon](/blog/2025/03/inspektor-gadget-at-kubecon-europe), [Contribfest](https://github.com/inspektor-gadget/Contribfest-KubeCon-NA2025), Container Days, [SCaLE](https://www.socallinuxexpo.org/), Open Source Observability Conference.
